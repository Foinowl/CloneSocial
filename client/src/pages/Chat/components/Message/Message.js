...
const Message = ({ user, chat, index, message }) => {
    ...
    return (
			...
			>
				...
				>
					{/* TODO: Добавить селекторы для пересылаемого сообщения(mb-5 and repeat or forward) */}
					<div>
						{/* TODO: Дописать условие(сообщение от друга или repeat msg от друга) */}
